-- Add Missing Tables for Console Error Fixes
-- This creates the friendships table and find_discovery_matches function
...
-- ============================================================================
-- SCHEDULED_SHOWS (if not exists from simplified migration)
-- ============================================================================
