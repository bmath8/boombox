-- ============================================================================
-- FAM MUSIC V.2 - MASTER MIGRATION SCRIPT
-- ============================================================================
-- This script combines all database schemas in the correct execution order
-- Execute this entire file in your Supabase SQL Editor
-- Estimated execution time: 5-10 minutes
-- ============================================================================

-- ============================================================================
-- PART 1: EXTENSIONS AND CORE SCHEMA
-- ============================================================================
...
-- ============================================================================
-- PART 3: COLLABORATIVE PLAYLIST SCHEMA
-- ============================================================================
...
-- Update Listener Count Function
...
-- Create Collaborative Playlist Function
...
-- Vote on Playlist Track Function
...
-- Check and Unlock Badges Function
...
-- Create permissive policies for development (REPLACE WITH RESTRICTIVE POLICIES IN PRODUCTION)
...
CREATE POLICY "Allow all for radio_listeners" ON public.radio_listeners FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all for station_chat_messages" ON public.station_chat_messages FOR ALL USING (true) WITH CHECK (true);
...
-- ============================================================================
-- Next steps:
-- 1. Verify tables were created: SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = 'public';
-- 2. Verify functions were created: SELECT COUNT(*) FROM information_schema.routines WHERE routine_schema = 'public';
-- 3. Test core functions
-- 4. Configure real-time subscriptions in your application
-- ============================================================================
